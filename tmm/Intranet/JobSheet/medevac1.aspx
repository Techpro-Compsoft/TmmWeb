<%@ Page Language="vb" AutoEventWireup="false" Codebehind="medevac1.aspx.vb" Inherits="JobSheet.medevac1" ValidateRequest="false"%>
				...
				<TR vAlign="top">
					<TD align="center" width="100%">
						<TABLE style="BORDER-RIGHT: #307fa3 1px solid; BORDER-TOP: #307fa3 1px solid; BORDER-LEFT: #307fa3 1px solid; BORDER-BOTTOM: #307fa3 1px solid"
							...
							<tr height="20">
								<td align="center"><cc1:progressindicator id="ucProgress" runat="server" Height="48px" BoookEndStart="images/img_Start.gif"
										BoookEndFinish="images/img_End.gif" LastAvailableStep="5" CurrentStep="5" LinkURLs="locationinfo.aspx,locationsup.aspx,contractingcompany.aspx,crewtransportation.aspx,medevac1.aspx,medevac-uscg.aspx,medevac-mc.aspx,medevac-mcAlt.aspx,ambulance.aspx,hospitals-trauma.aspx,hospital-burn.aspx,clinic.aspx,edit-complete.aspx,edit-complete2.aspx"
										...
										<TR>
											<TD align="center">
												<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
													<tr class="stdFont">
														<td style="WIDTH: 245px" align="right"><asp:label id="lblSelectEvac" runat="server">Select a Crew Helicopter:</asp:label></td>
														<TD colSpan="3">
														    <rad:RadComboBox id="ddlMedEvac" CausesValidation="false" runat="server" AutoPostBack="True" Width="155px" DropDownWidth="550px" MaxHeight="300px" HighlightTemplatedItems="true" Skin="Gray">
														        <ItemTemplate>
                                                                    <table>
                                                                        <tr>
													...
													<TR class="stdFont">
														<TD style="WIDTH: 245px" align="right">Company Name:</TD>
														<TD style="WIDTH: 164px"><asp:textbox id="txtCompName" runat="server" MaxLength="50"></asp:textbox></TD>
													...
													<TR class="stdFont">
														<TD style="WIDTH: 245px" align="right">Phone Number:</TD>
														<TD style="WIDTH: 164px"><asp:textbox id="txtPhone" runat="server" MaxLength="50"></asp:textbox></TD>
													...
													<TR class="stdFont">
														<TD style="WIDTH: 245px; HEIGHT: 12px" align="right">Alternative Phone Number:</TD>
														<TD style="WIDTH: 164px; HEIGHT: 12px"><asp:textbox id="txtAltPhone" runat="server" MaxLength="50"></asp:textbox></TD>
														<td style="WIDTH: 130px; HEIGHT: 12px" colSpan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
													</TR>
													<tr class="stdFont">
														<td style="WIDTH: 245px" align="right">Fax Number:</td>
														<td style="WIDTH: 164px"><asp:textbox id="txtFax" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 245px" align="right">City:</td>
														<td style="WIDTH: 164px"><asp:textbox id="txtCity" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 245px" align="right">State:</td>
														<td style="WIDTH: 164px"><asp:textbox id="txtState" runat="server" MaxLength="15"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
												</TABLE>
													...
													<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR class="stdFont" align="center">
															<TD style="WIDTH: 377px" align="right">&nbsp;Choose style of Longitude/Latitude 
																entry:&nbsp;</TD>
															<TD align="left"><asp:radiobutton id="rbMinutes" runat="server" Checked="True" AutoPostBack="True" GroupName="Group1"
																	Text="Minutes and Seconds"></asp:radiobutton><asp:radiobutton id="rbDecimal" runat="server" AutoPostBack="True" GroupName="Group1" Text="Decimals"></asp:radiobutton></TD>
														</TR>
														<TR align="center">
															<TD class="stdFont" colSpan="2">
																<P class="stdFont"><asp:panel id="pnlMinutes" runat="server" Height="48px">
																					<TABLE id="Table3" cellSpacing="1" cellPadding="5" width="600" border="0">
																						<TR class="stdFont">
																						    ...
																						    <td>
																							    N/S</td>
																							<td><asp:DropDownList id="ddlNSMinutes" tabIndex="11" runat="server" Width="50px"></asp:DropDownList>
																						...
																						<TR class="stdFont">
																						    ...
																						    <td>
																								Seconds</td>
																							<td><asp:TextBox id="txtLongSeconds" tabIndex="14" runat="server" MaxLength="10" Width="75px"></asp:TextBox>
																...
																<P class="stdFont"><asp:panel id="pnlDecimal" runat="server" Height="32px">
																		<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="300" border="0">
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLat2" runat="server" ControlToValidate="txtLat2" Display="Dynamic" ErrorMessage="Latitude must be numeric"
																						Type="Double" Operator="DataTypeCheck" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLat2" runat="server" ControlToValidate="txtLat2" Display="Dynamic" ErrorMessage="Latitude must be between 0 and 90 degrees"
																						Type="Double" MinimumValue="0" MaximumValue="90" Enabled="False">*</asp:RangeValidator>&nbsp;
																				</td>
																				<td>
																					N/S&nbsp;
																				</td>
																			...
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLong2" runat="server" ControlToValidate="txtLong2" Display="Dynamic" ErrorMessage="Longitude degrees must be numeric"
																						Type="Double" Operator="DataTypeCheck" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLong2" runat="server" ControlToValidate="txtLong2" Display="Dynamic" ErrorMessage="Longitude must be between 0 and 180 degrees"
																						Type="Double" MinimumValue="0" MaximumValue="180" Enabled="False">*</asp:RangeValidator>&nbsp;
																				</td>
																				<td>
																					E/W&nbsp;
																				</td>
																...
																<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="98%" border="0">
																	<TR>
																		<TD><asp:button id="btnClear" runat="server" Text="Clear Crew Helicopter" CssClass="btnSmall" CausesValidation="False"></asp:button></TD>
