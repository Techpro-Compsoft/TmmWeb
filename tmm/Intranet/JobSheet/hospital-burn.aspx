<%@ Page Language="vb" AutoEventWireup="false" Codebehind="hospital-burn.aspx.vb" Inherits="JobSheet.hospital_burn" ValidateRequest="false"%>
							...
							<tr height="20">
								<td align="center">
									<cc1:ProgressIndicator id="ucProgress" runat="server" Height="48px" BoookEndGraphics="True" BoookEndStartActive="images/img_Start_o.gif"
										...
										CurrentStep="11" LastAvailableStep="11" BoookEndFinish="images/img_End.gif" BoookEndStart="images/img_Start.gif"></cc1:ProgressIndicator></td>
							</tr>
								...
								<TD vAlign="top" align="center">
									<TABLE class="smallBorder" id="Table1" cellSpacing="1" cellPadding="1" width="98%" align="center"
										...
										<TR class="DataGridHdr">
											<TD class="SecHdr" style="HEIGHT: 16px">&nbsp;Hospital (closest, burn)
											</TD>
										</TR>
										<TR>
											<TD align="center">
												<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
													<TR class="stdFont">
														<TD style="WIDTH: 288px; HEIGHT: 1px" align="right"><asp:label id="lblSelectHosp1" runat="server">Select a Hospital:</asp:label></TD>
														<TD style="WIDTH: 160px; HEIGHT: 1px" colSpan="4"><rad:RadComboBox id="ddlSelectHosp1" runat="server" HighlightTemplatedItems="true" CausesValidation="false" DropDownWidth="550px" AutoPostBack="True" Width="156px" Skin="Gray">
														    <ItemTemplate>
                                                                    <table>
                                                                        <tr>
                                                                            <td style="width:325px; font-family:Arial; font-size:12px">
                                                                                <%#DataBinder.Eval(Container, "Attributes['ServiceName']")%>
                                                                            </td>
                                                                            <td style="width:90px; font-family:Arial; font-size:12px">
													...
													<TR class="stdFont">
														<TD style="WIDTH: 288px" align="right">Company Name:</TD>
														<TD style="WIDTH: 165px"><asp:textbox id="txtCompName" runat="server" Width="156" MaxLength="50"></asp:textbox>
													...
													<TR class="stdFont">
														<TD style="WIDTH: 288px" align="right">Phone Number:</TD>
														<TD style="WIDTH: 165px"><asp:textbox id="txtPhone" runat="server" MaxLength="50"></asp:textbox></TD>
													...
													<TR class="stdFont">
														<TD style="WIDTH: 288px; HEIGHT: 12px" align="right">Alternative Phone Number:</TD>
														<TD style="WIDTH: 165px; HEIGHT: 12px"><asp:textbox id="txtAltPhone" runat="server" MaxLength="50"></asp:textbox></TD>
														<td style="HEIGHT: 12px" align="center" colSpan="2"></td>
													</TR>
													<tr class="stdFont">
														<td style="WIDTH: 288px" align="right">Fax Number:</td>
														<td style="WIDTH: 165px"><asp:textbox id="txtFax" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 288px" align="right">City:</td>
														<td style="WIDTH: 165px"><asp:textbox id="txtCity" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 288px" align="right">State:</td>
														<td style="WIDTH: 165px"><asp:textbox id="txtState" runat="server" MaxLength="15"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 288px" align="right">Radio Frequency:</td>
														<td style="WIDTH: 165px"><asp:textbox id="txtFreq" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
												</TABLE>
													...
													<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR class="stdFont" align="center">
															<TD style="WIDTH: 368px" align="right">&nbsp;Choose style of Longitude/Latitude 
																entry:&nbsp;</TD>
															<TD align="left"><asp:radiobutton id="rbMinutes" runat="server" AutoPostBack="True" Text="Minutes and Seconds" GroupName="Group1"
																	Checked="True"></asp:radiobutton><asp:radiobutton id="rbDecimal" runat="server" AutoPostBack="True" Text="Decimals" GroupName="Group1"></asp:radiobutton></TD>
														</TR>
														<TR align="center">
															<TD class="stdFont" colSpan="2">
																...
																<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="98%" border="0">
																	<TR>
																		<TD><asp:button id="btnClear" runat="server" Text="Clear Burn Unit" CssClass="btnSmall" CausesValidation="False"></asp:button></TD>
