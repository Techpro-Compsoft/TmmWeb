...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="medevac-uscg.aspx.vb" Inherits="JobSheet.medevac_uscg" ValidateRequest="false"%>
				...
				<TR vAlign="top">
					<TD align="center" width="100%">
						<TABLE style="BORDER-RIGHT: #307fa3 1px solid; BORDER-TOP: #307fa3 1px solid; BORDER-LEFT: #307fa3 1px solid; BORDER-BOTTOM: #307fa3 1px solid"
							...
							<tr height="20">
								<td align="center">
									<cc1:ProgressIndicator id="ucProgress" runat="server" Height="48px" BoookEndStartActive="images/img_Start_o.gif"
										...
										CurrentStep="6" LastAvailableStep="6" BoookEndFinish="images/img_End.gif" BoookEndStart="images/img_Start.gif"
										...
										<TR>
											<TD align="center">
												...
												<P class="stdFont"><BR>
													<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR class="stdFont" align="center">
															<TD style="WIDTH: 382px" align="right">&nbsp;Choose style of Longitude/Latitude 
																entry:&nbsp;</TD>
															<TD align="left">
																<asp:radiobutton id="rbMinutes" runat="server" Text="Minutes and Seconds" GroupName="Group1" AutoPostBack="True"
																	...
																	<asp:panel id="pnlMinutes" Height="48px" runat="server">
																					<TABLE id="Table4" cellSpacing="1" cellPadding="5" width="600" border="0">
																						...
																						<TR class="stdFont">
																							...
																							<TD>
																							    Degrees</td>
																						    <td><asp:TextBox id="txtLong1" tabIndex="12" runat="server" MaxLength="10" Width="75px"></asp:TextBox>
																		...
																		<TABLE id="Table9" cellSpacing="1" cellPadding="1" width="300" border="0">
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLat2" runat="server" Operator="DataTypeCheck" Type="Double" ErrorMessage="Latitude must be numeric"
																						Display="Dynamic" ControlToValidate="txtLat2" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLat2" runat="server" Type="Double" ErrorMessage="Latitude must be between 0 and 90 degrees"
																						Display="Dynamic" ControlToValidate="txtLat2" MaximumValue="90" MinimumValue="0" Enabled="False">*</asp:RangeValidator>&nbsp;
																				</td>
																				<td>
																					N/S&nbsp;
																				</td>
																			...
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLong2" runat="server" Operator="DataTypeCheck" Type="Double" ErrorMessage="Longitude degrees must be numeric"
																						Display="Dynamic" ControlToValidate="txtLong2" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLong2" runat="server" Type="Double" ErrorMessage="Longitude must be between 0 and 180 degrees"
																						Display="Dynamic" ControlToValidate="txtLong2" MaximumValue="180" MinimumValue="0" Enabled="False">*</asp:RangeValidator>&nbsp;
																				</td>
																				<td>
																					E/W&nbsp;
																				</td>
												...
												<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="98%" border="0">
													<TR>
														<TD>
															<asp:button id="btnClear" runat="server" Text="Clear Med-Evac" CssClass="btnSmall" CausesValidation="False"></asp:button></TD>
														<TD align="right">
