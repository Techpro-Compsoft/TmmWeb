...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="medevac-mc.aspx.vb" Inherits="JobSheet.medevac_mc" ValidateRequest="false"%>
							...
							<tr height="20">
								<td align="center">
									<cc1:ProgressIndicator id="ucProgress" runat="server" Height="48px" BoookEndGraphics="True" BoookEndStartActive="images/img_Start_o.gif"
										...
										CurrentStep="7" LastAvailableStep="7" BoookEndFinish="images/img_End.gif" BoookEndStart="images/img_Start.gif"></cc1:ProgressIndicator></td>
							</tr>
												...
												<P class="stdFont"><BR>
													<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR class="stdFont" align="center">
															<TD style="WIDTH: 380px" align="right">&nbsp;Choose style of Longitude/Latitude 
																entry:&nbsp;</TD>
															<TD align="left">
														...
														<TR align="center">
															<TD class="stdFont" colSpan="2">
																		...
																		<TABLE id="Table9" cellSpacing="1" cellPadding="1" width="300" border="0">
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLat2" runat="server" ErrorMessage="Latitude must be numeric" Display="Dynamic"
																						ControlToValidate="txtLat2" Operator="DataTypeCheck" Type="Double" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLat2" runat="server" ErrorMessage="Latitude must be between 0 and 90 degrees"
																						Display="Dynamic" ControlToValidate="txtLat2" Type="Double" MaximumValue="90" MinimumValue="0" Enabled="False">*</asp:RangeValidator>&nbsp;
																				</td>
																				<td>
																				    N/S&nbsp;
																				</td>
																			...
																			<TR class="stdFont">
																				...
																				<td>
																					...
																					<asp:CompareValidator id="cvLong2" runat="server" ErrorMessage="Longitude degrees must be numeric" Display="Dynamic"
																						ControlToValidate="txtLong2" Operator="DataTypeCheck" Type="Double" Enabled="False">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLong2" runat="server" ErrorMessage="Longitude must be between 0 and 180 degrees"
																						Display="Dynamic" ControlToValidate="txtLong2" Type="Double" MaximumValue="180" MinimumValue="0"
																...
																<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="98%" border="0">
																	<TR>
																		<TD>
																			<asp:button id="btnClear" runat="server" Text="Clear Med-Evac Alternate 1" CssClass="btnSmall" CausesValidation="False"></asp:button></TD>
																		<TD align="right">
