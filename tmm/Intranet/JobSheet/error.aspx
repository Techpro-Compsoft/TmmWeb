...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="error.aspx.vb" Inherits="JobSheet._error" %>
								...
								<TD align="left" vAlign="top">
									<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="98%" border="0" align="center"
										...
										<TR CLASS="DataGridHdr">
											<TD class="SecHdr">&nbsp;Job Information Sheet Error</TD>
										</TR>
										<TR class="stdFont">
											<TD align="center">
												<P>An error has occured in the Job Information Sheet program.<BR>
													This error has been reported to technical support via email.</P>
