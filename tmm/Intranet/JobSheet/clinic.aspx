...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="clinic.aspx.vb" Inherits="JobSheet.clinic" ValidateRequest="false"%>
				...
				<TR vAlign="top">
					<TD align="center" width="100%">
						<TABLE style="BORDER-RIGHT: #307fa3 1px solid; BORDER-TOP: #307fa3 1px solid; BORDER-LEFT: #307fa3 1px solid; BORDER-BOTTOM: #307fa3 1px solid"
							...
							<tr height="20">
								<td align="center"><cc1:progressindicator id="ucProgress" BoookEndStart="images/img_Start.gif" BoookEndFinish="images/img_End.gif"
										LastAvailableStep="12" CurrentStep="12" LinkURLs="locationinfo.aspx,locationsup.aspx,contractingcompany.aspx,crewtransportation.aspx,medevac1.aspx,medevac-uscg.aspx,medevac-mc.aspx,medevac-mcAlt.aspx,ambulance.aspx,hospitals-trauma.aspx,hospital-burn.aspx,clinic.aspx,edit-complete.aspx,edit-complete2.aspx"
										...
										BoookEndFinishActive="images/img_End_o.gif" BoookEndStartActive="images/img_Start_o.gif" BoookEndGraphics="True" Height="48px"
								...
								<TD vAlign="top" align="center">
									<TABLE class="smallBorder" id="Table1" cellSpacing="1" cellPadding="1" width="98%" align="center"
										...
										<TR class="DataGridHdr">
											<TD class="SecHdr" style="HEIGHT: 16px">&nbsp;Clinic (closest, limited capability)
											</TD>
										</TR>
										<TR>
											<TD align="center">
												<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
													<TR class="stdFont">
														<TD style="WIDTH: 286px; HEIGHT: 1px" align="right"><asp:label id="lblSelectHosp1" runat="server">Select a Clinic:</asp:label></TD>
														<TD style="WIDTH: 160px; HEIGHT: 1px" colSpan="4">
														<rad:RadComboBox id="ddlSelectHosp1" runat="server" AutoPostBack="True" Width="155px" DropDownWidth="545px" CausesValidation="false" Skin="Gray" MaxHeight="300px" HighlightTemplatedItems="true">
														    <ItemTemplate>
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td style="width:150px; font-family:Arial; font-size:12px">
                                                                                <%#DataBinder.Eval(Container, "Attributes['Category']")%>
                                                                            </td>
                                                                            <td style="width:85px; font-family:Arial; font-size:12px">
													...
													<TR class="stdFont">
														...
														<TD style="WIDTH: 166px"><asp:textbox id="txtCompName" runat="server" Width="156" MaxLength="50"></asp:textbox>
													...
													<TR class="stdFont">
														...
														<TD style="WIDTH: 166px"><asp:textbox id="txtPhone" runat="server" MaxLength="50"></asp:textbox></TD>
													...
													<TR class="stdFont">
														...
														<TD style="WIDTH: 166px; HEIGHT: 12px"><asp:textbox id="txtAltPhone" runat="server"></asp:textbox></TD>
														<td style="HEIGHT: 12px" align="center" colSpan="2"></td>
													</TR>
													<tr class="stdFont">
														<td style="WIDTH: 286px" align="right">Fax Number:</td>
														<td style="WIDTH: 166px"><asp:textbox id="txtFax" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 286px" align="right">City:</td>
														<td style="WIDTH: 166px"><asp:textbox id="txtCity" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 286px" align="right">State:</td>
														<td style="WIDTH: 166px"><asp:textbox id="txtState" runat="server" MaxLength="15"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
													<tr class="stdFont">
														<td style="WIDTH: 286px" align="right">Radio Frequency:</td>
														<td style="WIDTH: 166px"><asp:textbox id="txtFreq" runat="server" MaxLength="50"></asp:textbox></td>
														<td style="WIDTH: 131px"></td>
														<td></td>
													</tr>
												</TABLE>
													...
													<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<TR class="stdFont" align="center">
															<TD style="WIDTH: 368px" align="right">&nbsp;Choose style of Longitude/Latitude 
																entry:&nbsp;</TD>
															<TD align="left"><asp:radiobutton id="rbMinutes" runat="server" AutoPostBack="True" GroupName="Group1" Text="Minutes and Seconds"></asp:radiobutton><asp:radiobutton id="rbDecimal" runat="server" AutoPostBack="True" GroupName="Group1" Text="Decimals"
														...
														<TR align="center">
															<TD class="stdFont" colSpan="2">
																		...
																		<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="600" border="0">
																			<TR class="stdFont">
																				...
																				<TD style="HEIGHT: 17px">
																				    Degrees</td>
																				<td>
																					<asp:TextBox id="txtLat1" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					<asp:RequiredFieldValidator id="rfvLat1" runat="server" ControlToValidate="txtLat1" Display="Dynamic" ErrorMessage="Please enter Latitude degrees">*</asp:RequiredFieldValidator>
																					<asp:CompareValidator id="cvLat1" runat="server" ControlToValidate="txtLat1" Display="Dynamic" ErrorMessage="Latitude degrees must be numeric"
																						Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLat1" runat="server" ControlToValidate="txtLat1" Display="Dynamic" ErrorMessage="Latitude must be between 0 and 90 degrees"
																						Type="Double" MaximumValue="90" MinimumValue="0">*</asp:RangeValidator>
																			    </td>
																			    <td>
																					Minutes</td>
																			    <td>
																					<asp:TextBox id="txtLatMinutes" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					...
																					<asp:CompareValidator id="cvLatMinutes" runat="server" ControlToValidate="txtLatMinutes" Display="Dynamic"
																						ErrorMessage="Latitude minutes must be numeric" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLatMinutes" runat="server" ControlToValidate="txtLatMinutes" Display="Dynamic"
																						ErrorMessage="Latitude minutes must be between 0 and 60" Type="Double" MaximumValue="60" MinimumValue="0">*</asp:RangeValidator>
																			    </td>
																			    <td>
																					Seconds</td>
																				<td>
																					<asp:TextBox id="txtLatSeconds" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					...
																					<asp:CompareValidator id="cvLatSeconds" runat="server" ControlToValidate="txtLatSeconds" Display="Dynamic"
																						ErrorMessage="Latitude seconds must be numeric" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLatSeconds" runat="server" ControlToValidate="txtLatSeconds" Display="Dynamic"
																						ErrorMessage="Latitude seconds must be between 0 and 60" Type="Double" MaximumValue="60" MinimumValue="0">*</asp:RangeValidator>
																				</td>
																				<td>
																					N/S</td>
																				<td>
																					<asp:DropDownList id="ddlNSMinutes" runat="server" Width="50px"></asp:DropDownList>
																			...
																			<TR class="stdFont">
																				...
																				<TD>
																				    Degrees</td>
																				  <td>
																					<asp:TextBox id="txtLong1" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					...
																					<asp:CompareValidator id="cvLong1" runat="server" ControlToValidate="txtLong2" Display="Dynamic" ErrorMessage="Longitude degrees must be numeric"
																						Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLong1" runat="server" ControlToValidate="txtLong1" Display="Dynamic" ErrorMessage="Longitude degrees must be between 0 and 180"
																						Type="Double" MaximumValue="180" MinimumValue="0">*</asp:RangeValidator>
																				</td>
																				<td>
																					Minutes</td>
																				<td>
																					<asp:TextBox id="txtLongMinutes" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					...
																					<asp:CompareValidator id="cvLongMinutes" runat="server" ControlToValidate="txtLongMinutes" Display="Dynamic"
																						ErrorMessage="Longitude minutes must be numeric" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLongMinutes" runat="server" ControlToValidate="txtLongMinutes" Display="Dynamic"
																						ErrorMessage="Longitude minutes must be between 0 and 60 minutes" Type="Double" MaximumValue="60"
																						MinimumValue="0">*</asp:RangeValidator>
																				</td>
																				<td>
																					Seconds</td>
																				<td>
																					<asp:TextBox id="txtLongSeconds" runat="server" Width="75px" MaxLength="10"></asp:TextBox>
																					...
																					<asp:CompareValidator id="cvLongSeconds" runat="server" ControlToValidate="txtLongSeconds" Display="Dynamic"
																						ErrorMessage="Longitude seconds must be between 0 and 60" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
																					<asp:RangeValidator id="rvLongSeconds" runat="server" ControlToValidate="txtLongSeconds" Display="Dynamic"
																						ErrorMessage="Longitude seconds must be between 0 and 60" Type="Double" MaximumValue="60" MinimumValue="0">*</asp:RangeValidator>
																				</td>
																				<td>
																				    E/W</td>
																				<td>																				    
																					<asp:DropDownList id="ddlEWMinutes" runat="server" Width="50px"></asp:DropDownList>
																...
																<TABLE id="Table7" cellSpacing="1" cellPadding="1" width="98%" border="0">
																	<TR>
																		<TD><asp:button id="btnClear" runat="server" Text="Clear Clinic" CssClass="btnSmall" CausesValidation="False"></asp:button></TD>
