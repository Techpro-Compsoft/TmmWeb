<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sessionend.aspx.vb" Inherits="JobSheet.sessionend"%>
								...
								<TD align="left" vAlign="top">
									<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="98%" border="0" align="center"
										...
										<TR CLASS="DataGridHdr">
											<TD class="SecHdr">&nbsp;Session Ended</TD>
										</TR>
										<TR class="stdFont">
											<TD align="center">
												<P>Your session with the TMM Job Information Sheet program has expired.</P>
												<P>Please close your browser window and enter the program again.</P>
											</TD>
										</TR>
									</TABLE>
								</TD>
