<%@ Control Language="vb" AutoEventWireup="false" Codebehind="NavigationMenu.ascx.vb" Inherits="MyAccount.NavigationMenu" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
