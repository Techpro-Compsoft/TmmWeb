                                    ...
                                    <telerik:radgrid id="rgCategories" Skin="Outlook2007"  enableembeddedskins="false"
                                        ...
                                        <mastertableview datakeynames="ID" gridlines="Horizontal">
                                            ...
                                            <detailtables>
                                                ...
                                                pagesize="50" datakeynames="ID" selfhierarchysettings-parentkeyname="ID" hierarchyloadmode="ServerOnDemand" 
                                                gridlines="Horizontal" width="100%" nodetailrecordstext="No Videos Available">
                                                    ...
                                                    <columns>
                                                        <telerik:gridboundcolumn headerstyle-horizontalalign="Left" headertext="Videos" datafield="Name" />
                                                        <telerik:gridtemplatecolumn headertext="Views">
                                                            <itemtemplate>
                                                                <asp:literal id="litVideoViews" runat="server" />
                                                            </itemtemplate>
                                                        </telerik:gridtemplatecolumn>
                                                        <telerik:gridtemplatecolumn headertext="Last Viewed">
                                                            <itemtemplate>
                                                                <asp:literal id="litLastViewed" runat="server" />
                                                            </itemtemplate>
                                                        </telerik:gridtemplatecolumn>
                                                        <telerik:gridtemplatecolumn headertext="Options" itemstyle-horizontalalign="Right">
                                                            <itemtemplate>
                                                                <table cellpadding="0" cellspacing="0">
                                                                    <tr>
