<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_Medic.aspx.cs" Inherits="UsersAdmin.UserInfo_Medic" %>
	...
	<asp:ScriptManager ID="sm1" runat="server"></asp:ScriptManager>
	    <center>
			<table width="760" style="height:100%" cellpadding="0" cellspacing="0" border="0" class="SmallBorder">
				    ...
				    <td style="padding:10px;">
				        <radT:RadTabStrip ID="tabStrip" runat="server" ontabclick="tabStrip_TabClick" AutoPostBack="true" CausesValidation="false" Skin="Web20">
				            <Tabs>
				                ...
				                <radT:Tab ID="tabCredentials" runat="server" Text="Credentials"></radT:Tab>
			            ...
			            <asp:MultiView ID="mvwUserInfo" runat="server" ActiveViewIndex="0">
                            ...
                            <asp:View ID="View4" runat="server">
                                <table style="width:100%; border:1px solid white;">
                                    <tr>
                                       <td style="padding:10px;">
                                            <uc4:AddCredential ID="AddCredential1" runat="server" />
                                        </td>
                                    </tr>
                                </table>                                
                            </asp:View>
				...
				<tr>
					<td style="text-align:left; padding:10px;"><span class="WhiteText"><a href="javascript:history.go(-1)" class="WhiteLnk">&nbsp;&lt;&nbsp;Back</a></span>
                    </td>
				</tr>
				<tr valign="bottom">
					<td>
