<%@ Control Language="vb" AutoEventWireup="false" Codebehind="NavigationMenu.ascx.vb" Inherits="TrinityMedicalManagement.NavigationMenu" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
