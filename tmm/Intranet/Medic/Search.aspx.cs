...
namespace TrinityMedicalManagement
{
	...
	/// </summary>
	public partial class Search : TMMPage
	{
    ...
    #region Buttons
            ...
            protected void btnClear_Click(object sender, EventArgs e)
            {
                ...
                rgEncounterResults.Visible = false;
        ...
        #region MyRegion
        private void setupGrid(int PatientID)
        {

            DataTool dbTool = new DataTool();
            DataTable dtMedications = dbTool.getMedications(PatientID);
            ...
            //dgMeds.DataBind();
            DataTable dtVitals = dbTool.getVitals(PatientID);
        ...
        #region dgDocuments_SelectedIndexChanged
        protected void dgDocuments_SelectedIndexChanged(object sender, EventArgs e)
        {
            
            Response.Redirect  (dgDocuments.SelectedItem.Cells[2].ToString());
        ...
        protected void rgEncounterResults_ItemCommand(object source, Telerik.WebControls.GridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                strJS = "<script language='JavaScript'>window.opener.document.location.href='patient.aspx?PatientID=" + strPatientID + "';window.close();</script>";
                Page.ClientScript.RegisterStartupScript(Page.GetType(), "changeURL", strJS);
                //Page.ClientScript.RegisterStartupScript(Page.GetType(), "close", "<script language='JavaScript'></script>");
            }
        }
