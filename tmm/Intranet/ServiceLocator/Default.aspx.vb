...
#Region " Page_Load "
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsNumeric(Me.txtRadius.Text) AndAlso Not CInt(Me.txtRadius.Text) > 1000 AndAlso Not CInt(Me.txtRadius.Text) < 10 Then
            ...
            Dim SVGHtml As String = "<object id=""Object1"" width=""900"" height=""475"" " & _
                "codebase=""http://download.adobe.com/pub/adobe/magic/svgviewer/win/3.x/3.03/en/SVGView.exe"" " & _
                "type=""image/svg-xml""> " & _
                "<param name=""src"" value=""" & ViewString & """ /> " & _
                "<embed id=""Embed1"" " & _
                "name=""chart"" " & _
                "width=""900px"" " & _
                "height=""475"" " & _
                "src=""" & ViewString & """ " & _
                "type=""image/svg-xml"" " & _
                "pluginspage=""http://download.adobe.com/pub/adobe/magic/svgviewer/win/3.x/3.03/en/SVGView.exe""> " & _
                "</embed> " & _
                "</object>"
            Me.litSVG.Text = SVGHtml
        Else
